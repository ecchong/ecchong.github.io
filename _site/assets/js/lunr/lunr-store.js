var store = [{
        ...
        "excerpt":"Build a new EE image We would like to use a third part collection, in this case community.efficientip, in our playbooks. The collection is currently in the Automation Hub server and it also requires a Python module, SOLIDserverRest, which is available via pip. Since this Python module is no available...","categories": ["Ansible"],
